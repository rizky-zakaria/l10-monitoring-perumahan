                                    ...
                                    <li class="timeline-item">
                                        ...
                                        <div class="timeline-item-content">
                                            <div class="m-l-10">
                                                ...
                                                <p class="m-b-0">
                                                    <span class="font-weight-semibold">Complete task
                                                    </span>
                                    ...
                                    <li class="timeline-item">
                                        ...
                                        <div class="timeline-item-content">
                                            <div class="m-l-10">
                                                ...
                                                <p class="m-b-0">
                                                    <span class="font-weight-semibold">Attached file
                                                    </span>
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <label for="task-today-2" class="d-flex align-items-center">
                                                <div class="inline-block m-l-10">
                                                    ...
                                                    <p class="m-b-0 text-muted font-size-13">I'm gonna
                                                        build me an airport</p>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <label for="task-week-4" class="d-flex align-items-center">
                                                <div class="inline-block m-l-10">
                                                    ...
                                                    <p class="m-b-0 text-muted font-size-13">Trillion a
                                                        very small stage in a vast</p>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <label for="task-month-1" class="d-flex align-items-center">
                                                <div class="inline-block m-l-10">
                                                    ...
                                                    <p class="m-b-0 text-muted font-size-13">Nipperkin run
                                                        a rig ballast chase</p>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-month-3" class="d-flex align-items-center">
                                                <div class="inline-block m-l-10">
                                                    <h5 class="m-b-0">Customize Template</h5>
                                                    <p class="m-b-0 text-muted font-size-13">I'll be sure
                                                        to note that</p>
                                                </div>
                                            </label>
                                        </div>
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <label for="task-month-5" class="d-flex align-items-center">
                                                <div class="inline-block m-l-10">
                                                    ...
                                                    <p class="m-b-0 text-muted font-size-13">European
                                                        minnow priapumfish mosshead</p>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
